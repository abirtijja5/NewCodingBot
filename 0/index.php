...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">abirtijja6@gmail.com.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+212 123456789</li>	
					<li class="s-bar">
						<div class="search">
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Tijja Hotel</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
				   ...
				   <div class="ab-w3l-spa">
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Merci d'être très intelligent pour faire quelque chose de bien. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p> abirtijja/abirtijja/abirtijja/abirtijja/abirtijja/abirtijja.</p>
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">about me </h3>
			<div id="horizontalTab">
					<ul class="resp-tabs-list">
					<ul>
					<li>
						<img src="images/q.png" alt=" " class="img-responsive" />
					</li>
				</ul>
					...
					<div class="tab4">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>I'm abir, a student with 2 years of experience. My passion for informatics started when I was in high school.  I always felt that front end developer was an exciting way to express myself. Right now, I'm committed to teaching and expressing myself by front end developer.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+212 123456789</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">abirtijja6@gmail.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> NR123456, laayoune, Maroc</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113616.10853881543!2d-13.253573126822758!3d27.14044753695692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xc3772c616b079c9%3A0x9bea0d2b555fce5f!2zTGHDonlvdW5l!5e0!3m2!1sfr!2s!4v1649434361124!5m2!1sfr!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 Tijja Hotel . All Rights Reserved | Design by <a href="index.php">abir tijja</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
